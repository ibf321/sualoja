...
class LojasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create loja" do
    assert_difference('Loja.count') do
      post lojas_url, params: { loja: { descrcao: @loja.descrcao, name: @loja.name, segmente: @loja.segmente, tag: @loja.tag } }
    end
  ...
  test "should update loja" do
    patch loja_url(@loja), params: { loja: { descrcao: @loja.descrcao, name: @loja.name, segmente: @loja.segmente, tag: @loja.tag } }
